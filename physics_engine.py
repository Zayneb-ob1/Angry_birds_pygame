...
def add_vectors(vector1, vector2):
    ...
    return Vector(new_magnitude, new_angle)
...
class Pig:
    def __init__(self, x, y, r, v=None, type="PIG", loaded=False, color=(255, 255, 255)):
        ...
        self.y = y
        self.r = r
        self.velocity = v if v else Vector()
        ...
        self.image = random.choice([self.pig1_image, self.pig2_image]) if type == "PIG" else self.bird_image
        self.type = type
        self.color = color
        self.loaded = loaded
        self.path = []
...
class Bird(Pig):
    ...
    def reposition(self, slingshot, mouse_click):
        ...
        if self.mouse_selected():
            ...
            self.velocity.magnitude = min(hypot(dx, dy)/2, 80)
...
class Block:
    def __init__(self, x, y, r, v=None, color=(120, 40, 31)):
        self.r = 50
        self.w = 100
        self.h = 100
        self.x = x
